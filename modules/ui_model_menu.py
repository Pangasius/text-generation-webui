                ...
                with gr.Box():
                    with gr.Row():
                        ...
                        with gr.Column():
                            ...
                            shared.gradio['use_llama_index'] = gr.Checkbox(label="use-llama-index", value=shared.args.use_llama_index, info='Use LlamaIndex to query additional information to form responses. Place the index in the Index folder.')
